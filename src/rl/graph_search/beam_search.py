...
def beam_search(pn, e_s, q, e_t, kg, num_steps, beam_size, return_path_components=True, use_kg_pred=False, kg_pred=None, fn_kg=None):
    """
    ...
    with open('output.dat', 'wb') as file:
        pickle.dump(beam_search_output, file)
